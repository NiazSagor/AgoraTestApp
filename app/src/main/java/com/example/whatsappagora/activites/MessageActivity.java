...
public class MessageActivity extends AppCompatActivity {
    ...
    private ImageView startAudioCall, startVideoCall;
    ...
    private void init() {
        ...
        startAudioCall = findViewById(R.id.audio_call);
        startAudioCall.setOnClickListener(onClickListener);
        startVideoCall = findViewById(R.id.video_call);
        startVideoCall.setOnClickListener(onClickListener);
    ...
    private final View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (view.getId() == R.id.audio_call) {
                startAudioCall();
            } else if (view.getId() == R.id.video_call) {
    ...
    private void startVideoCall(String mTargetName) {
        String myName = user.getFireDisplayName();

        String channelName = myName.compareTo(mTargetName) < 0 ? myName + mTargetName : mTargetName + myName;
    ...
    private void startAudioCall() {
        startActivity(new Intent(MessageActivity.this, VoiceChatViewActivity.class));
    }
}
